...
namespace QuizMvc.QuizApi
{
    ...
    /// </summary>
    public partial class Subscriptions : IServiceOperations<QuizAPIClient>, ISubscriptions
    {
        /// <summary>
        ...
        /// </param>
        public Subscriptions(QuizAPIClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse> PostWithHttpMessagesAsync(WebHook webhook, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (webhook == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/Subscriptions").ToString();
